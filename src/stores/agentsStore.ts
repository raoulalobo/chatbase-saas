  ...
  persist(
    (set, get) => ({
      ...
      createAgent: async (data: CreateAgent) => {
        ...
        return { success: false, error: 'Erreur lors de la création de l\'agent - aucune donnée reçue' }
      },
      ...
      updateAgent: async (id: string, data: UpdateAgent) => {
        ...
        return { success: false, error: 'Erreur lors de la mise à jour de l\'agent - aucune donnée reçue' }
      },
